...
/**
 * The Interface TreeBuilder helps in building domain model tree out of each domain object read.
 *
 * @param <T> the generic type to represent the type of object for which tree needs to be built.
