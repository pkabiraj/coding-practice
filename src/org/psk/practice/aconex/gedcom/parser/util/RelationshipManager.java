...
/**
 * The Class RelationshipManager is an utility class to establish different types of relationships between nodes.
 *
...
public final class RelationshipManager {
    ...
    /**
     * Establishes relationship between old member in the node tree with the new member.
     *
