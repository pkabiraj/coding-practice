...
/**
 * The Class ParentNodeAdapter is to adapt a leaf node to parent node. This is
 * helpful because we are not sure before hand while parsing gedcom file whether
 * the current node has children or not unless we parse the next line.
 * 
