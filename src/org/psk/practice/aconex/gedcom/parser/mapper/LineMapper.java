...
/**
 * The Interface LineMapper is for mapping lines (strings) to domain objects
 * typically used to map lines read from a file to domain objects on a per line
 * basis. Implementations of this interface perform the actual work of parsing a
