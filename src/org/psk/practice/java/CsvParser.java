 ...
 * 
 * @param <T>
 *            the generic type to represent the type of data to be returned
 */
interface Reader<T> {
...
interface LineTokenizer {
	 ...
	 * 
	 * @param line
	 *            the line to be tokenized (can be <code>null</code>)
	 * 
...
class StdInputReader<T> implements Reader<T> {
	...
	private LineMapper<T> lineMapper; // Maps 1 line to domain object
